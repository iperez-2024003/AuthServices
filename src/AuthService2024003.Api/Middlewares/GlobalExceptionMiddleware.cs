...
using AuthService2024003.Api.Models;
using AuthService2024003.Application.Exceptions;

namespace AuthService2024003.Api.Middlewares;
...
public class GlobalExceptionMiddleware(RequestDelegate next, ILogger<GlobalExceptionMiddleware> logger)
{
    ...
    private static async Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        // Construir respuesta unificada para el cliente
        var unified = new
        {
            success = false,
            ...
            timestamp = response.Timestamp // Ahora coincide con el modelo
        };
